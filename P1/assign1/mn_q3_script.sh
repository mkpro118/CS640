...
h9 java -cp /home/mininet/Private/CS640/P1/bin/ Iperfer -c -h 10.0.0.7 -p 5001 -t 20 > answersT.txt
h9 echo -e 'Done!\n'

h10 echo -n 'Running Iperfer client between h10 and h1... '
h10 java -cp /home/mininet/Private/CS640/P1/bin/ Iperfer -c -h 10.0.0.1 -p 5001 -t 20 > answersT.txt
h10 echo -e 'Done!\n'
